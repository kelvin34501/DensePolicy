...
class RealWorldDatasetALOHA(Dataset):
    ...
    def __init__(
        ...
        # self.projectors = {} # ! REMOVED because aloha training works in joint space
    ...
    def __getitem__(self, index):
        ...
        # ! TURN OFF aug, as joint angles cannot be augmented
        ...
        qpos_list = torch.from_numpy(qpos_list).float().squeeze(0)
        qpos_list_normalized = torch.from_numpy(qpos_list_normalized).float().squeeze(0)
        ...
        ret_dict = {
            ...
            "qpos" : qpos_list,
            "qpos_normalized" : qpos_list_normalized,
        }
